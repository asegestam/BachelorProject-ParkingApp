...
interface ZoneService {
    ...
    @GET("https://data.goteborg.se/ParkingService/v2.1/HandicapParkings/1d6e729b-4f57-4c48-be1b-712bac46a08e?latitude=57.7088&longitude=11.9745&radius=2000&format=JSON")
